      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 lg:px-20 xl:px-28 py-8 sm:py-10 md:py-12">
        ...
        <div className="flex flex-col gap-8 sm:gap-10 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[#888] text-sm font-mono max-w-xs leading-relaxed">
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg border border-[#222] flex items-center justify-center text-[#888] hover:text-white hover:border-[#444] hover:bg-white/5 transition-all duration-300"
              >
