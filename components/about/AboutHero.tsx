...
const AboutHero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full min-h-[90vh] flex items-center px-10 md:px-20 lg:px-28 overflow-hidden"
    >
      {/* Decorative blurs */}
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-16 w-full">
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          {/* Bio */}
          <div
            className={`max-w-lg space-y-4 transition-all duration-700 delay-400 ${
              mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          {/* Quick stats */}
          <div
            className={`flex gap-8 mt-2 transition-all duration-700 delay-500 ${
              mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            {[
        ...
        >
          {/* Main card */}
          <div className="relative w-85 h-110 rounded-3xl border border-[#ffffff0a] bg-[#0a0a0a]/80 backdrop-blur-md overflow-hidden group">
            {/* Gradient top accent */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-red-500 via-orange-500 to-red-500" />

            {/* Photo placeholder */}
            <div className="w-full h-65 bg-linear-to-br from-[#1a1a1a] to-[#0a0a0a] flex items-center justify-center relative overflow-hidden">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {["React", "Node.js", "Solidity", "Next.js"].map((tag) => (
                  <span
                    key={tag}
          ...
          <div className="absolute -top-4 -right-4 w-20 h-20 rounded-2xl border border-red-500/20 bg-red-500/5 backdrop-blur-sm flex items-center justify-center text-2xl animate-bounce" style={{ animationDuration: "3s" }}>
            ⚡
          </div>
          <div className="absolute -bottom-3 -left-3 w-16 h-16 rounded-xl border border-violet-500/20 bg-violet-500/5 backdrop-blur-sm flex items-center justify-center text-xl animate-bounce" style={{ animationDuration: "4s", animationDelay: "1s" }}>
            🚀
          </div>
        </div>
      </div>
